...
from car_studio.fields.codenerf_field import CodeNerfField
...
@dataclass 
class CodeNerfConfig(VanillaModelConfig):
    """Code Nerf Config"""

    _target: Type = field(default_factory=lambda: CodeNerfModel)
    background_color: Literal["random", "black", "white"] = "random"
    enable_collider: bool = False
    latent_width: int = 512

class CodeNerfModel(Model):
    """Code Nerf model
