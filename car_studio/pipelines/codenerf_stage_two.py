...
@dataclass
class CodeNerfStageTwoPipelineConfig(BaseStageTwoPipelineConfig):
    """codenerf stage two pipeline"""

    _target: Type = field(default_factory=lambda: CodeNerfStageTwoPipeline)
    """target class to instantiate"""
    latent_dim: int = 512

class CodeNerfStageTwoPipeline(BaseStageTwoPipeline):
    """
